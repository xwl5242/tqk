...
public class ColorThief {
	...
	public static String getImagePixelFromUrl(String url) {
		try{
			URL url1 = new URL(url);
			return getImagePixel(url1);
		}catch(Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static String getImagePixel(URL url) {
	...
	private static String common(BufferedImage bi) {
		int R, G, B;
	...
	public static void main(String[] args) {
		System.out.println(getImagePixel("f:\\80.jpg"));
	}
